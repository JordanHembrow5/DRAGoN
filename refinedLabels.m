...
function lbl = twoFilamentCase(lbl, indices, bp)
    ...
    if(max(lbl_three,[],'all','omitnan') ~= 3) %some very exotic shapes can cause problems and are ignored
        return;
    end
